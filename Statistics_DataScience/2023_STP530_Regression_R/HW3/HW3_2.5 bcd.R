...
# basic histogram
breaks_vector <- seq(from=0, to=170, by=10)
hist(HW2.data$min,breaks=breaks_vector, main="Histogram of Minutes", xlab="min", ylab="Frequency")
...
hist(e, breaks=breaks_vector, main="Histogram of Minutes", xlab="min", ylab="Frequency")
